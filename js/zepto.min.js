...
window.Zepto = Zepto, "$" in window || (window.$ = Zepto),
	...
	function(a, b) {
		...
		}), k = c + "transform", r[l = c + "transition-property"] = r[m = c + "transition-duration"] = r[n = c + "transition-timing-function"] = r[o = c + "animation-name.txt"] = r[p = c + "animation-duration"] = r[q = c + "animation-timing-function"] = "", a.fx = {
